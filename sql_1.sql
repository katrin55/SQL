...
select name, id from students where id > 140;
 ...
 -- 20. Вывести пользователя у которых id меньше 13
select name, id from students where id < 13;
...
select name, password from students where password in ('1233', '1m313', '123313');
